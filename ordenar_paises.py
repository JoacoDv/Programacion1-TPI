...
""")
    ...
    respuesta = int(input("Escriba su elección: "))
...
""")
    ...
    if respuesta == 1:
        ...
        print("Los paises ordenados alfabeticamente son:\n")
    ...
    # opcion 2 ordena por la poblacion de menor a mayor
        ...
        print("Los paises ordenados De menor poblacion a mayor son: ")
        mostrar_paises(paises_ordenados)
